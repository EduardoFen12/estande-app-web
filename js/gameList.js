const GameListModule = (function() {
	const apiUrl = "https://wondrous-evenly-catfish.ngrok-free.app/games";

	// Função para criar o elemento de jogo na página
	function createGameDiv(game) {
		...
		// Redireciona para a página de formulário ao clicar no jogo
...
// Inicializa o módulo quando a página estiver carregada
